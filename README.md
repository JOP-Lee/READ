...
The following instructions describe installation of conda environment.  Please refer to [requirement](https://github.com/JOP-Lee/READ/requirement.sh)
If you want to set it to headless mode(without X server enabled), see the MyRender in the [src folder](https://github.com/JOP-Lee/READ/src). 
...
## Acknowledgments
In this code we refer to the following implementations: [npbg](https://github.com/yenchenlin/nerf-pytorch) and [
